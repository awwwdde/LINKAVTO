    ...
    <section className="w-full max-w-[1720px] mx-auto px-5 mt-[100px]" data-header-theme="dark">
      <div ref={containerRef} className="w-full relative mt-[50px]">
        <div className="relative w-[1720px] h-[400px] rounded-[15px] overflow-hidden mx-auto flex items-stretch">
          ...
          <div ref={textRef} className="absolute bottom-[40px] left-[40px] z-10 flex flex-row items-center gap-10">
            <div className="flex flex-col justify-center">
              <span className="text-white text-[40px] font-bold">Вы продавец?</span>
