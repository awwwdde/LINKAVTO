...
const HowToSellSection = ({ steps }: HowToSellSectionProps) => {
  ...
  return (
    <section ref={sectionRef} id="how-to-sell" className="w-full max-w-[1720px] mx-auto px-4 sm:px-5 mt-12 sm:mt-16 md:mt-20 lg:mt-[100px]">
      <h2 ref={titleRef} className="text-xl sm:text-2xl md:text-[24px] mb-2 font-semibold">
        Начать продавать — еще проще
      </h2>
